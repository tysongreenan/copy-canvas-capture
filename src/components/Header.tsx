...
export function Header() {
  return (
    <header className="sticky top-0 border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 z-10">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
          <Link to="/" className="flex items-center gap-2 font-sans font-bold tracking-tight">
            ...
            <span className="text-xl uppercase tracking-tight">Lumen</span>
          </Link>
          <div className="hidden md:block ml-2 border-l pl-2">
            <span className="text-xs text-muted-foreground tracking-tight">Shedding Light on Hidden Copy</span>
          </div>
        </div>
