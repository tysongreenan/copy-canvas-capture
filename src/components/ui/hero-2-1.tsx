  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="flex flex-col items-end absolute -right-60 -top-10 blur-xl z-0 ">
        <div className="h-[10rem] rounded-full w-[60rem] z-1 bg-gradient-to-b blur-[6rem] from-tan to-cream"></div>
        <div className="h-[10rem] rounded-full w-[90rem] z-1 bg-gradient-to-b blur-[6rem] from-charcoal to-tan"></div>
        <div className="h-[10rem] rounded-full w-[60rem] z-1 bg-gradient-to-b blur-[6rem] from-tan to-cream"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto mt-12 px-4 text-center">
          <h1 className="mx-auto max-w-4xl text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl uppercase tracking-tight">
          ...
          <div className="mt-10 flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
            ...
            <button 
              ...
              className="h-12 rounded-full border border-tan px-8 text-base font-medium text-tan hover:bg-tan/10"
            >
              Try Demo
            </button>
          </div>
          ...
          <div className="relative mx-auto my-20 w-full max-w-6xl">
            ...
            <div className="relative w-full bg-cream/10 rounded-lg p-16 backdrop-blur-sm">
              <div className="text-center">
                <Dog className="w-48 h-48 mx-auto text-tan animate-wag origin-bottom mb-8" />
                <h3 className="text-2xl font-bold text-cream mb-4">Meet Beggor</h3>
                <p className="text-lg text-gray-300">Your faithful content-fetching companion</p>
              </div>
            </div>
          </div>
        </div>
